...
- 2026-08-03 — Bump `vite` devDependency `^8.1.5` → `^8.2.0` (minor) — branch `loop/bump-vite` — verifier APPROVE (npm test 24/24, npm run lint clean, npm run build both index.html+iframe.html), PR opened
