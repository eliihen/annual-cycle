...
- 2026-08-04 — `npm audit fix`: bump `brace-expansion` 5.0.7 → 5.0.9 (high, GHSA-rgw5-rvv9-x895, bypassed the 2026-07-28 mitigation) and `postcss` 8.5.19 → 8.5.25 (moderate, GHSA-fxqj-rqcc-2cmp) — branch `loop/npm-audit-fix-brace-postcss`, PR #49 — verifier APPROVE, PR opened
