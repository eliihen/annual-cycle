...
/**
 * The full annual-cycle app: the `Wheel` plus the searchable/filterable
 * sidebar and category legend. Unlike `Wheel`, this owns all of its own UI
 * state (selection, search, category filter, year) — it's the complete
 * widget this repo deploys to GitHub Pages, not a controlled primitive.
 *
 * `tasks` must already be run through `processTasks()`, same as `Wheel`.
 */
export default function AnnualCycleApp({ tasks: allTasks, initialYear }) {
